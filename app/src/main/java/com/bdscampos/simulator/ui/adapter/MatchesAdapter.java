package com.bdscampos.simulator.ui.adapter;
...
import com.bdscampos.simulator.databinding.MatchItemBinding;
import com.bdscampos.simulator.domain.Match;
import com.bdscampos.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (match.getHomeTeam().getScore() != null) holder.binding.tvHomeTeamScore.setText(String.valueOf(match.getHomeTeam().getScore()));
        ...
        if (match.getAwayTeam().getScore() != null) holder.binding.tvAwayTeamScore.setText(String.valueOf(match.getAwayTeam().getScore()));
